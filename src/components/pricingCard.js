      ...
      <div className="shadow-md rounded-md my-2 border border-gray-200">
        <div className="flex flex-col h-40">
          <div className="flex h-full">
            ...
            <div className="flex flex-col w-1/3 items-center justify-center bg-background rounded-tr-md">
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-2 row-gap-2 px-6">
            <div className="flex">
        ...
        <div className="flex flex-col px-6 py-2">
          <div className="flex flex-col">
            <p className="text-gray-700 text-center mb-2 underline">
